...
import com.hafidrf.lokaloops.ui.login.LoginActivity
            ...
            dialog.btn_change_ok?.setOnClickListener {
                ...
                if (dialog.et_old_password.text.toString().equals(tvPassword.toString())) {
                    ...
                    if (dialog.et_new_password.text.toString().equals(dialog.et_confirm_password.text.toString())) {
                        ...
                        //KIRIM PASSWORD
                        EndPoint.client.create(InterfacePoint::class.java).kirimPass(
                            idUser.toString(),
                            dialog.et_confirm_password.text.toString()
                        ).enqueue(object : Callback<NewPassResponse> {
                        ...
                        Toast.makeText(
                            activity,
                            "Periksa kembali password baru anda",
                            Toast.LENGTH_LONG
                        ).show()
